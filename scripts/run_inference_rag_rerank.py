...
Pipeline per sample:
  ...
  2. Qwen generates caption of query image
  3. EVA-CLIP text encoder embeds caption and doc texts
  4. Re-rank top-10 by combining visual + textual scores
  5. Qwen answers using top-3 re-ranked docs as context
"""
