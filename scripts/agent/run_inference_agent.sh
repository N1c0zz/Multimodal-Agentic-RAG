...
#SBATCH --mem=64G
#SBATCH --output=/homes/%u/cvcs2026/logs/out/agent_topk8_onlyguesses_%j.out
#SBATCH --error=/homes/%u/cvcs2026/logs/err/agent_topk8_onlyguesses_%j.err
...
python /homes/$USER/cvcs2026/scripts/agent/run_inference_agent.py \
    --output_dir /work/cvcs2026/feature_extractors/dati_progetto/predictions/agent_topk8_onlyguesses \
    --top_k 8 \
    --max_steps 5 \
    --max_new_tokens 512
