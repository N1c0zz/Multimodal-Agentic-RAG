...
#SBATCH --output=/homes/%u/cvcs2026/logs/out/eval_agent_topk8_weight05_%j.out
#SBATCH --error=/homes/%u/cvcs2026/logs/err/eval_agent_topk8_weight05_%j.err
#SBATCH --account=cvcs2026

source /work/cvcs2026/feature_extractors/venv_eval/bin/activate

PRED_DIR=/work/cvcs2026/feature_extractors/dati_progetto/predictions/agent_topk8_weight05
